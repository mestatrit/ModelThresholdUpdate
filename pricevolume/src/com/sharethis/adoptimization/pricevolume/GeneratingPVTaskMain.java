...
public class GeneratingPVTaskMain
{
	private static Logger sLogger = Logger.getLogger(GeneratingPVTaskMain.class);
		
    public static void main(String[] args) throws Exception {
		sLogger.info("Starting the task to generate the pv ...\n");
		Configuration config = new Configuration();
        Class<?> jobClass = Class.forName("com.sharethis.adoptimization.pricevolume.GeneratingPVTask");
