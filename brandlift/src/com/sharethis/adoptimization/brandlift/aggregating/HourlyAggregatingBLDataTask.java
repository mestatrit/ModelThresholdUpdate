...
public class HourlyAggregatingBLDataTask extends Configured implements Tool
{
	private static final Logger sLogger = Logger.getLogger(HourlyAggregatingBLDataTask.class);
	...
	public int run(String[] args) throws Exception {
		...
		HourlyAggregatingBLData hgData = new HourlyAggregatingBLData();
		sLogger.info("\nStarting the generation of hourly data at hour " + hourFolder + " on " + pDateStr + " ...");
		hgData.aggregatingBLDataHourly(config, hour);
