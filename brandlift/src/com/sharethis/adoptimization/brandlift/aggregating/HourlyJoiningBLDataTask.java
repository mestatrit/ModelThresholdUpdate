...
public class HourlyJoiningBLDataTask extends Configured implements Tool
{
	private static final Logger sLogger = Logger.getLogger(HourlyJoiningBLDataTask.class);
	...
	public int run(String[] args) throws Exception {
		...
		HourlyJoiningBLData hgData = new HourlyJoiningBLData();
		sLogger.info("\nStarting the generation of hourly aata at hour " + hourFolder + " on " + pDateStr + " ...");
		hgData.joiningBLDataHourly(config, hour);
