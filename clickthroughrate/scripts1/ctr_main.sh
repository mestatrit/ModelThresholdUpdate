...
do
   ...
   do   
       ...
       #( ${BIN_DIR}/data_click_hourly.sh ${string_after} >> ${LOGS_FILE_PATH}/data_click_hourly_${string_h_after}.log 2>&1 ) &
       #pid_clk=$!
       #wait $pid_imp $pid_clk
