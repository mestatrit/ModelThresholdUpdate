...
MOD_DATA_DIR_HOURLY="${HDFS_DIR_HOURLY}/camp_data_hourly"
...
parm_mod_data_hourly="ModFilePathHourly=${MOD_DATA_DIR_HOURLY}/"
...
ctr_parm="${parm_res} ${parm_q_name} ${parm_date} ${parm_out_hourly} ${parm_mod_data_hourly} ${parm_out_daily}"
