...
parm_mod_c="ModDataClick=mod_data_click"
parm_mod_ct="ModDataCount=mod_data_count"
parm_mod_nc="ModDataNonClick=mod_data_nonclick"
parm_mod_d="ModDataName=mod_data"
parm_mod_s="SampleMultiplier=25"

parm_q_name="QueueName=${QUEUENAME_DATA_HOURLY}"
qName="-Dmapred.job.queue.name=${QUEUENAME_DATA_HOURLY}"

data_parm="${parm_sb_path} ${parm_sb_name} ${parm_num_bid} ${parm_num_click} ${parm_reducer} ${parm_q_name} ${parm_date} ${parm_hour} ${parm_out_hourly} ${parm_out_daily} ${parm_imp} ${parm_click} ${parm_pc} ${parm_click_svr} ${parm_mod_c} ${parm_mod_nc} ${parm_mod_ct} ${parm_mod_d} ${parm_mod_s}"
