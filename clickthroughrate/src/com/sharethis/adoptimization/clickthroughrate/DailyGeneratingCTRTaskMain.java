 ...
 * The command line to run: hadoop jar ClickThroughRateRunner.jar com.sharethis.adoptimization.clickthroughrate.DailyGeneratingCTRTaskMain
 */


public class DailyGeneratingCTRTaskMain
{
	private static Logger sLogger = Logger.getLogger(DailyGeneratingCTRTaskMain.class);
		
    public static void main(String[] args) throws Exception {
		sLogger.info("Starting the task to generate the ctr ...\n");
		Configuration config = new Configuration();
        Class<?> jobClass = Class.forName("com.sharethis.adoptimization.clickthroughrate.DailyGeneratingCTRTask");
