...
import com.sharethis.adoptimization.common.FilterOutDataNEStr;
...
public class CTRPMassagingModelData extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(CTRPMassagingModelData.class);
	private static final long serialVersionUID = 1L;
	
	public CTRPMassagingModelData(Fields inKeyFields_i, Fields inKeyFields, Pipe inAssembly, int modThresholdVal, 
