...
public class CTRPGeneratingData extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(CTRPGeneratingData.class);
	private static final long serialVersionUID = 1L;
	
	public void generatingDataForModels(Configuration config) throws Exception{
		try{
	...
	private void processingCTRData(Configuration config, String pDateStr, String ctrFilePath, 
		...
		try{
			...
			Pipe[] dataAssembly = new CTRPProcessingData(sources_agg, config, pDateStr, 
...
//					fileName = modFilePathDate+pipeName+"_"+i_data;
		    ...
		    AppProps.setApplicationJarClass(properties, CTRPGeneratingData.class);
