...
/**
 * main class to run the computation.
  */


public class PCGeneratingModelMain
{
	private static Logger sLogger = Logger.getLogger(PCGeneratingModelMain.class);
		
    public static void main(String[] args) throws Exception {
		sLogger.info("Starting the task to generate the data for models ...\n");
		Configuration config = new Configuration();
        Class<?> jobClass = Class.forName("com.sharethis.adoptimization.clickthroughrate.ctrmodel.PCGeneratingModelTask");
