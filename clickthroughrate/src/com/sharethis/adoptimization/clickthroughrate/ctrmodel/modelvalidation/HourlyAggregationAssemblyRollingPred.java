...
import com.sharethis.adoptimization.clickthroughrate.OneCTRDataAssembly;
...
public class HourlyAggregationAssemblyRollingPred extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(HourlyAggregationAssemblyRollingPred.class);
	private static final long serialVersionUID = 1L;
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	
	public HourlyAggregationAssemblyRollingPred(Map<String, Tap> sources, String outFilePathHourly, String outFilePathDaily, 
		...
		throws IOException, ParseException, Exception
	{
		try{		
			...
			ctrAssemblyRolling_tmp[0] = new OnePredCTRDataAssembly(sources, outFilePathHourly, outFilePathDaily, 
			...
			if(ctrAssemblyRolling_tmp[0]!=null){	
				...
				ctrAssemblyRolling_tmp[1] = new OnePredCTRDataAssembly(sources, outFilePathHourly, outFilePathDaily, 
				...
				sLogger.info("The number of data sets: " + cnt_pipe);
