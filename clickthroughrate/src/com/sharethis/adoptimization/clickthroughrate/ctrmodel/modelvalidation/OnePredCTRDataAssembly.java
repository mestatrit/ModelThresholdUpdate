...
public class OnePredCTRDataAssembly extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(OnePredCTRDataAssembly.class);
	private static final long serialVersionUID = 1L;
	private static String mDelimiter = "\t";
	
	public OnePredCTRDataAssembly(Map<String, Tap> sources, String outFilePathHourly, String outFilePathDaily, 
