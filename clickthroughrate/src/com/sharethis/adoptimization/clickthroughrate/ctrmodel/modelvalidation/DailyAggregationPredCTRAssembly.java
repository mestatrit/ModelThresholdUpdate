...
public class DailyAggregationPredCTRAssembly extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(DailyAggregationPredCTRAssembly.class);
	private static final long serialVersionUID = 1L;
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	private static String mDelimiter = "\t";
	
	public DailyAggregationPredCTRAssembly(Map<String, Tap> sources, 
