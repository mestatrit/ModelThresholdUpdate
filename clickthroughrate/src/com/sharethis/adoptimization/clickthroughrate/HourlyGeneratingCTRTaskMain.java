...
public class HourlyGeneratingCTRTaskMain
{
	private static Logger sLogger = Logger.getLogger(HourlyGeneratingCTRTaskMain.class);
		
    public static void main(String[] args) throws Exception {
		sLogger.info("Starting the task to generate the ctr ...\n");
		Configuration config = new Configuration();
        Class<?> jobClass = Class.forName("com.sharethis.adoptimization.clickthroughrate.HourlyGeneratingCTRTask");
