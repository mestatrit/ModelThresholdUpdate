...
public class HourlyGeneratingCTRTask extends Configured implements Tool
{
	private static final Logger sLogger = Logger.getLogger(HourlyGeneratingCTRTask.class);
	...
	public int run(String[] args) throws Exception {
		...
		switch(aggFlag){
		case 0:
			hList.hourlyCTRAggFromHourlyData(config, hour);
			break;
		case 1:
			hList.hourlyCTRAggFromHourlyBase(config, hour);
//			hList.hourlyCTRAggFromHourlyDataEx(config, hour);
			break;
		}
		return 0;		
	}		
