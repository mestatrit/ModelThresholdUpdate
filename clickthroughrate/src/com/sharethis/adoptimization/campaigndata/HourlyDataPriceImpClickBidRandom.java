...
public class HourlyDataPriceImpClickBidRandom extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(HourlyDataPriceImpClickBidRandom.class);
	private static final long serialVersionUID = 1L;

	public HourlyDataPriceImpClickBidRandom(Pipe allAssembly, Fields keptFields, Configuration config) 
			throws IOException, ParseException, Exception
	{
		try{				
			...
			adxAssembly = new Each(adxAssembly, new Fields("platform_type1", "deviceType"), filterOutData); 
