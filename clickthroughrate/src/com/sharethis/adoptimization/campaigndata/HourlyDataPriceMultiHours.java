...
public class HourlyDataPriceMultiHours extends SubAssembly
{
	private static final Logger sLogger = Logger.getLogger(HourlyDataPriceMultiHours.class);
	private static final long serialVersionUID = 1L;
	private SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	private static String mDelimiter = "\t";
	
	public HourlyDataPriceMultiHours(Map<String, Tap> sources, String priceFilePath, String pDateStr, int hour, Configuration config) 
		throws IOException, ParseException, Exception
	{
		try{		
            ...
            for(int i=0; i<3; i++){
				...
				String filePathHourly = priceFilePath + dayStr_temp + CTRConstants.hourFolders[i_temp] + "/";
//				String filePathHourly = priceFilePath + dayStr_temp + "/" + CTRConstants.hourFolders[i_temp] + "/";
