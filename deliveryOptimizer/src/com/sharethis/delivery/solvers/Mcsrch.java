...
public class Mcsrch {
	...
	public static String mcsrch(int n, double[] x, double f, double[] g, double[] s, int is0, double[] stp, double ftol,
		...
		if (info[0] != -1) {
			...
			if (dginit >= 0) {
				return " (The search direction is not a descent direction)";
			}
