...
\
com.sharethis.doreport.server.ReportServer -iap bin/res/dors.properties -il4jp bin/res/log4j.properties -ipb /mnt/dors -opb . -dop bin/res/deliveryOptimizer.properties > /mnt/ReportServer.log 2>&1 &
